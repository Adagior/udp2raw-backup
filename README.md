...
nohup ./udp2raw_amd64 -s -l0.0.0.0:1212 -r 127.0.0.1:2222  -k "passwd" --raw-mode faketcp   --cipher-mode xor  -a >/dev/null 2>&1 &

客户端
nohup ./udp2raw_amd64 -c -l0.0.0.0:2222 -r?.?.?.?:1212 -k "passwd" --raw-mode faketcp   --cipher-mode xor  -a >/dev/null 2>&1 &
